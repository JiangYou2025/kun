...
线性代数研究**向量、矩阵与线性变换**。神经网络的每一层运算、几乎所有降维与表示方法，都建立在它之上——可以说它是机器学习的"母语"。
...
- **每一层神经网络**本质都是矩阵乘法 + 非线性，注意力机制是 $QK^\top V$ 的矩阵运算。
- **降维与压缩**：PCA、[SVD](../svd/)、嵌入（embedding）都靠线性代数。
- **GPU 加速**：硬件就是为大规模矩阵乘法优化的，这是深度学习能跑起来的物理前提。
