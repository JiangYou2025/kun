...
> **想把这块地基打得更系统？** 这一页只讲直觉、只挑了最核心的几样。配套的[基础课](../../foundations/)是更完整的概念地图：[📐 数学基础](../../foundations/math/)（微积分、线性代数、概率统计、优化、信息论）与 [🤖 机器学习基础](../../foundations/ml/)（模型族、训练流程、泛化与评估、评估指标）——本页提到的损失函数、梯度下降、过拟合、正则化等术语，都能在那里找到更完整的展开。
