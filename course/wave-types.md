...
在炮兵小游戏里你用抛物线拟合了弹道。但现实中的数据很少只有一种形状——股价、温度、用电量、心电图，几乎都是**多种波形叠加**的结果。
...
> 把"复合波 = 信号 + 噪声"拆开、再分别预测，正是[第 4 讲 · 成分与分解](../04/)的主题；而其中"平稳 / 不可预测"的部分，则要靠[第 5 讲 · 平稳性](../05/)来处理。
