...
<div class="game" markdown="0">
  ...
  (function(){
    ...
    var rounds=[
      {h:[190,200,150,95,90,140, 190,200,150],   t:95,  n:'奶茶店日销量（周内周期·周末高）'},
      {h:[200,130,85,150,110,80, 200,130,85],     t:150, n:'每小时客流量（日内双峰·午晚高）'},
      {h:[95,92,98,110,185,195, 95,92,98],         t:110, n:'网站访问量（周内周期·工作日高）'},
      {h:[140,132,145,158,150,138, 140,132,145],   t:158, n:'机房温度（空调周期·小幅）'},
      {h:[200,175,188,150,165,120, 138,90,110],    t:70,  n:'股价（指数上涨 + 回撤）'}
    ];
    var MAX=5;
