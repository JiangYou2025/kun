...
<div class="cards" markdown="0">
  <div class="card">
    ...
    <h3>天气 · 气候</h3>
    <p>一场漏报的暴雨能让城市排水瘫痪、航班停飞、农田绝收，单次灾害损失常以数十亿计。气象预报员利用数值天气模型和雷达回波数据，可以提前 6–72 小时预测降水量、风速和落区。这为城市启动应急预案争取了黄金窗口，每年减少的气象灾害损失占 GDP 的 0.1%–0.3%。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">⚡</div>
    <h3>用电 · 能源</h3>
    <p>电网供需必须逐秒平衡，一旦失衡就面临大面积跳闸甚至全网崩溃，2021 年德州大停电造成了近 2000 亿美元经济损失。调度员使用负荷预测模型，可以提前 24 小时预判峰值负荷和可再生能源出力曲线。精准预测让电厂合理安排机组启停，每年为一个省级电网节省上千万元的调峰燃料费。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">📦</div>
    <h3>销量 · 库存</h3>
    <p>备多了资金压死在仓库、备少了爆款断货丢客户——全球零售业每年因库存失误损失超过 1.1 万亿美元。供应链团队利用时间序列模型预测每个 SKU 未来 1–4 周的销量走势。预测准确率每提升 1 个百分点，库存周转率可改善 2%–3%，直接释放数千万的运营资金。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">🚗</div>
    <h3>交通 · 出行</h3>
    <p>城市早晚高峰的拥堵每年造成人均数百小时的通勤浪费，仅北京一城的拥堵成本就超千亿元。交通指挥中心利用历史与实时车流数据，可以提前 30 分钟预测每条路段的流量变化。提前调度信号灯和分流方案，能将平均通勤时间缩短 10%–15%，每天改善数百万人的出行体验。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">🏥</div>
    <h3>健康 · 疾病</h3>
    <p>传染病暴发时，ICU 床位和呼吸机一旦耗尽，死亡率会成倍跳升——COVID-19 期间多国医疗系统曾因此被击穿。流行病学家利用时间序列和 SIR 类模型预测未来 2–4 周的病例增长趋势。提前两周的准确预测，能让医院从容调配人力和物资，将重症死亡率降低 20%–30%。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">📈</div>
    <h3>金融 · 风险</h3>
    <p>"黑天鹅"事件一旦到来，没有控住仓位的机构可能在一天内爆仓出局——2008 年雷曼兄弟倒闭引发了 22 万亿美元的全球市值蒸发。风控团队利用 GARCH、VaR 等波动率模型预测尾部风险和极端损失概率。准确的风险预测让机构提前调整对冲头寸，将极端行情下的最大回撤控制在可承受范围内。</p>
  </div>
</div>
