...
<div class="game" markdown="0">
  ...
  (function(){
    ...
    var rounds=[
      {h:[120,96,92,196,184,168],  t:150, n:'奶茶店日销量（周末高·周一低）'},
      {h:[200,150,80,150,118,90],  t:78,  n:'每小时客流量（午高·晚高·早低）'},
      {h:[96,100,182,190,104,98],  t:96,  n:'网站访问量（工作日高·周末低）'},
      {h:[150,140,150,138,150,142], t:148, n:'机房温度（稳定）'},
      {h:[150,118,162,128,172,138], t:170, n:'股价（近乎随机·难猜）'}
    ];
    var MAX=5;
