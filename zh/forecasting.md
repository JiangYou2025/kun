...
<div class="cards" markdown="0">
  <div class="card">
    ...
    <h3>天气 · 气候</h3>
    <p>气象预报员每天盯着卫星云图和雷达回波，最怕的就是突发暴雨漏报。一场没预警到的强对流，可能让整座城市排水瘫痪、航班全线取消。提前 6 小时精准预测降水量和落区，能为应急疏散争取黄金窗口，挽回数十亿的财产损失。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">⚡</div>
    <h3>用电 · 能源</h3>
    <p>电网调度员的工作是让发电和用电在每一秒保持平衡——差一点就跳闸。冬天早高峰、夏天空调潮，负荷曲线像过山车。准确预测明早的峰值负荷，能让电厂从容安排机组启停，既避免拉闸限电，又省下上千万的调峰燃料费。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">📦</div>
    <h3>销量 · 库存</h3>
    <p>供应链经理每天面对一道两难题：备多了资金压死在仓库里，备少了爆款断货丢掉客户。全国几万个 SKU，每个的销量曲线都不一样。预测下周每个品类的精确销量，直接决定了千万级的库存周转效率和客户满意度。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">🚗</div>
    <h3>交通 · 出行</h3>
    <p>交通指挥中心的大屏上，红色堵点一旦出现就已经晚了——信号灯调度必须在拥堵发生前 30 分钟启动。每条路、每个路口的车流量都在变化。预测未来半小时的路段流量，能让通勤时间缩短 15%，每天改善数百万人的出行体验。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">🏥</div>
    <h3>健康 · 疾病</h3>
    <p>公共卫生官员面对的是一道生死题：ICU 的床位明天还够不够？呼吸机和特效药该往哪个区域调？等到医院被挤兑再反应就太迟了。提前两周预测病例增长趋势，能让医疗系统从容调配人力、物资和床位，把被动应对变成主动布局。</p>
  </div>
  <div class="card">
    <div style="font-size:2.2rem;text-align:center;margin-bottom:4px">📈</div>
    <h3>金融 · 风险</h3>
    <p>风控经理最怕的不是亏钱，而是不知道可能亏多少。市场平时风平浪静，但"黑天鹅"来的那天如果仓位没有控住，整个机构都可能出局。预测波动率和尾部风险的大小，决定了该留多少安全垫——这是一家金融机构活下去还是爆仓的分界线。</p>
  </div>
</div>
