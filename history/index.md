...
>
> 三篇专题附录：[史前史与应用](prehistory/) · [时间的本质](nature-of-time/) · [时间悖论](paradoxes/)
...
- 序章按学科（数学 · 物理 · 控制/通信 · 序贯决策 · 科学计算）梳理跨越百年的源头；另设[史前史与应用](prehistory/)、[时间的本质](nature-of-time/)、[时间悖论](paradoxes/)三篇专题附录。
